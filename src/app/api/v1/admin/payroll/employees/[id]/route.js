...
function mapEmployeeToMongoose(emp) {
  ...
  return {
    ...
    salaryDetails: {
      bankAccount: {
        accountNumber: decrypt(emp.bankAccountNumber),
        bankName: emp.bankName,
        ifscCode: decrypt(emp.ifscCode),
        branch: emp.branch,
        branchAddress: emp.branchAddress,
      },
      panNumber: decrypt(emp.panNumber),
      aadharNumber: decrypt(emp.aadharNumber),
    },
...
export async function PUT(request, { params }) {
  try {
    ...
    const updateData = {
      ...
      bankAccountNumber: bAccount.accountNumber !== undefined ? encrypt(bAccount.accountNumber) : existingEmployee.bankAccountNumber,
      bankName: bAccount.bankName !== undefined ? bAccount.bankName : existingEmployee.bankName,
      ifscCode: bAccount.ifscCode !== undefined ? encrypt(bAccount.ifscCode) : existingEmployee.ifscCode,
      ...
      panNumber: sDetails.panNumber !== undefined ? encrypt(sDetails.panNumber) : existingEmployee.panNumber,
      aadharNumber: sDetails.aadharNumber !== undefined ? encrypt(sDetails.aadharNumber) : existingEmployee.aadharNumber,
